    ...
    try {
      ...
      if (res.data?.success) {
        setStats({
          ...
          activeIndustries: res.data.data.activeIndustries || ["Textile", "Packaging", "Logistics"]
        });
      }
    } catch (e) {
      console.error(e);
